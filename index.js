...
function init() {
    ...
    let dotLottiePlayer = `<dotlottie-player id="hideMeAfterFirstClick" src="https://lottie.host/f1200d4f-c488-4d91-a5de-5755c381e215/E3u3dVrawR.json"
                background="transparent" speed="1" style="width: 200px; height: 200px; position: absolute;" loop autoplay></dotlottie-player>`;
    btn.insertAdjacentHTML('afterbegin', dotLottiePlayer);
...
function add_relay() {
    ...
    relay_block = new THREE.Mesh(new THREE.BoxGeometry(50, 50, 10), new THREE.MeshBasicMaterial({
        color: "#ff0000",
        transparent: true,
        opacity: 0
    }));
...
function startGame() {
	document.getElementById('hideMeAfterFirstClick').style.display = "none";
    if (isStarted == false) {
